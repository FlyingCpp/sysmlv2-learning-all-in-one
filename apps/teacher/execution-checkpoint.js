...
const PHASE_ALLOWED_ACTIONS = Object.freeze({
  ...
  // Validator PASS不是用户目标完成。旧validated_passed和新的review pending都必须
  // 回到Main重新判断，不能在恢复时直接跳进Finalizer。
  validated_passed: Object.freeze(['replan_or_clarify']),
  main_review_pending: Object.freeze(['replan_or_clarify']),
