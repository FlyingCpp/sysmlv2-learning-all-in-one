...
export const agentPolicySchema = z
  .object({
    ...
    repairMaxOutputTokens: z.number().int().min(4_096).max(64_000),
    ...
    maxUniqueCandidateValidationsPerWorker: z.number().int().min(4).max(20),
    reviewedKnowledgeMaxNewQueriesPerRun: z.number().int().min(0).max(2),
...
export const DEFAULT_AGENT_POLICY: AgentPolicy = {
  ...
  maxUniqueCandidateValidationsPerWorker: 12,
  reviewedKnowledgeMaxNewQueriesPerRun: 2,
